...
config = {
	...
	useGcIdentity = true, --require GCIdentity
	...
	enableCheckPlate = true, --require garages
...
txt = {
	fr = {
		...
		help_text_open_cloackroom = "Appuyez sur ~INPUT_CONTEXT~ pour ouvrir le menu de gps",
		...
		cloackroom_take_service_hidden_title = "Prendre un gps d'équipe",
		cloackroom_take_service_swat_title = "Prendre le service (intervention)",
		cloackroom_break_service_title = "GPS retiré",
		...
		now_in_service_notification = "Vous êtes équipé d'un gps",
		break_service_notification = "Vous avez déposé votre gps",
		help_open_menu_notification = "Appuyer sur ~g~F9~w~ pour ouvrir le ~b~Menu Police anim",
		...
		become_cop_success = "Félicitation, vous êtes apte a prendre un gps !!~w~.",
		remove_from_cops = "Vous ne pouvez plus prendre de gps!~w~.",
