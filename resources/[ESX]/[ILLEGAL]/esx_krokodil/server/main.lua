...
local function TransformKroko(source)
    ...
    SetTimeout(10000, function()
        ...
        if PlayersTransformingKroko[source] == true then
            ...
            elseif codeineQuantity and essenceQuantity and disolvantQuantity and phosphorerougeQuantity and iodeQuantity and heroineQuantity < 3 then
                TriggerClientEvent('esx:showNotification', source, _U('not_enough_ingredient'))
            else
                xPlayer.removeInventoryItem('iode', 3)
                xPlayer.removeInventoryItem('codeine', 3)
                xPlayer.removeInventoryItem('essence', 3)
                xPlayer.removeInventoryItem('disolvant', 3)
                xPlayer.removeInventoryItem('phosphorerouge', 3)
