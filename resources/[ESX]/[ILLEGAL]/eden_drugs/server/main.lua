...
RegisterServerEvent('eden_drugs:buyblowtorch')
AddEventHandler('eden_drugs:buyblowtorch', function()

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  xPlayer.removeMoney(Config.Priceblowtorch)
  xPlayer.addInventoryItem('blowtorch', 1)
end)

RegisterServerEvent('eden_drugs:buyc4_bank')
AddEventHandler('eden_drugs:buyc4_bank', function()

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  xPlayer.removeMoney(Config.Pricec4_bank)
  xPlayer.addInventoryItem('c4_bank', 1)
end)

RegisterServerEvent('eden_drugs:buyrasperry')
AddEventHandler('eden_drugs:buyrasperry', function()

  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)

  xPlayer.removeMoney(Config.Pricerasperry)
