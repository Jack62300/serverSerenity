...
Config.TimeToSell = 45 -- how many seconds player have to wait/stand near ped
...
Config.WeedPrice = 25	-- sell price for single, not pooch (black money)
Config.MethPrice = 30	-- sell price for single, not pooch (black money)
Config.CokePrice = 30	-- sell price for single, not pooch (black money)
Config.OpiuPrice = 30	-- sell price for single, not pooch (black money)
Config.DistanceFromCity = 1500 -- set distance that player cant sell drugs too far from city
