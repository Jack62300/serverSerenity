Config = {}
	...
	Config.FishPrice = {a = 5, b = 10} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 200, b = 500} --Will get dirty money
	Config.SharkPrice = {a = 600, b = 800} --Will get dirty money
