...
function buy_animal()
    ...
    local price = price
    local elements = {
        {label = _U('buy_croquette') .. '- <span style="color:green;">$10</span>',   value = 'buy_croquette'},
        {label = _U('buy_ball') .. '- <span style="color:green;">$3</span>',        value = 'buy_ball'},
    }
    table.insert(elements, {label = _U('dog') .. '- <span style="color:green;">$300</span>',             					value = "chien",	price = 300})		
    table.insert(elements, {label = _U('cat') .. '- <span style="color:green;">$120</span>',             					value = "chat", price = 120})
    table.insert(elements, {label = _U('monkey') .. '- <span style="color:green;">$1800</span>',             				value = "singe", price = 1800})
    table.insert(elements, {label = _U('wolf') .. '- <span style="color:green;">$2000</span>',             				value = "loup", price = 2000})
    table.insert(elements, {label = _U('bunny') .. '- <span style="color:green;">$50</span>',             				    value = "lapin",	price = 50})
    table.insert(elements, {label = _U('husky') .. '- <span style="color:green;">$320</span>',             				value = "husky", price = 320})
    table.insert(elements, {label = _U('pig') .. '- <span style="color:green;">$500</span>',             				value = "cochon", price = 500})
    table.insert(elements, {label = _U('poodle') .. '- <span style="color:green;">$300</span>',             				value = "caniche", price = 300})
    table.insert(elements, {label = _U('pug') .. '- <span style="color:green;">$300</span>',             					value = "carlin", price = 300})
    table.insert(elements, {label = _U('retriever') .. '- <span style="color:green;">$400</span>',             			value = "retriever", price = 400})
    table.insert(elements, {label = _U('asatian') .. '- <span style="color:green;">$700</span>',             				value = "berger", price = 700})
    table.insert(elements, {label = _U('westie') .. '- <span style="color:green;">$200</span>',             				value = "westie", price = 200})
