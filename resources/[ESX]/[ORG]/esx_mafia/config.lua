...
Config.MafiaStations = {
  ...
  Mafia = {
    ...
    Armories = {
      { x = -799.8964, y = 177.2336, z = 71.8346 },
    },

    Vehicles = {
      {
        Spawner    = { x = -809.1541, y = 190.1781, z = 71.4787 },
        SpawnPoint = { x = -821.3015, y = 183.1947, z = 71.9766 },
        Heading    = 133.8527,
      }
    },
	...
	Helicopters = {
      {
        Spawner    = { x = 2000.312, y = 53005.667, z = 17003.627 },
    ...
    VehicleDeleters = {
      { x = -811.4077, y = 187.3597, z = 71.4786 },
    },

    BossActions = {
      { x = -807.6498, y = 181.1994, z = 71.1530 }
    },
