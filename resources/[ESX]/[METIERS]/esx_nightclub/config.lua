...
Config.Blips = {
    ...
    Blip = {
      Pos     = { x = 4.1603, y = 220.2599, z = 107.7267 },
      Sprite  = 614,
      Display = 4,
      Scale   = 1.4,
      Colour  = 4,
...
Config.Zones = {
    ...
    Vehicles = {
        Pos          = { x = -18.5743, y = 219.0299, z = 105.7443 },
        SpawnPoint   = { x = -27.4065, y = 212.1555, z = 106.5580 },
    ...
    VehicleDeleters = {
        Pos   = { x = -21.5323, y = 206.8450, z = 105.5533 },
...
-------- SHOPS --------
    ...
    Flacons = {
        ...
        Items = {
            ...
            { name = 'martini',    label = _U('martini'), price = 2 }
        },
    },
