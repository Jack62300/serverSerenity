...
Config.PoliceStations = {
	...
	LSPD = {
		...
		AuthorizedWeapons = {
			...
			{ name = 'WEAPON_ASSAULTSMG',       price = 250 },
...
Config.AuthorizedVehicles = {
	...
	sergeant = {
		...
		{
			model = 'sspres',
			label = 'Véhicule D escort'
		},
		{
			model = 'policet',
			label = 'Transport Police'
		},
		{
			model = 'riot',
			label = 'SWAT LOURD'
