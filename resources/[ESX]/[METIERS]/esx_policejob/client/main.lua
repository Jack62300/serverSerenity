...
function OpenCloakroomMenu()
	...
	if Config.EnableNonFreemodePeds then
		--table.insert(elements, {label = 'Tenue de la Gendarmerie', value = 'freemode_ped', maleModel = 's_m_y_sheriff_01', femaleModel = 's_f_y_sheriff_01'})
		--table.insert(elements, {label = 'Tenue de la Police Nationale', value = 'freemode_ped', maleModel = 's_m_y_cop_01', femaleModel = 's_f_y_cop_01'})
		table.insert(elements, {label = 'Tenue du RAID', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
		--table.insert(elements, {label = 'Tenue de la BAC', value = 'freemode_ped', maleModel = 's_m_m_ciasec_01', femaleModel = 'ig_michelle'})
		--table.insert(elements, {label = 'Tenue de Motard', value = 'freemode_ped', maleModel = 's_m_y_hwaycop_01', femaleModel = 's_f_y_hwaycop_01'})
		--table.insert(elements, {label = 'Tenue Froid Gendarmerie', value = 'freemode_ped', maleModel = 's_m_m_snowcop_01'})
		--table.insert(elements, {label = 'Tenue Plan Vigipirate', value = 'freemode_ped', maleModel = 's_m_y_marine_01'})
	end
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions',
	{
		...
		elements = {
			...
			{label = "Travaux Interets Généraux",               value = 'jail_menu'}
		}
	}, function(data, menu)
		...
		if data.current.value == 'citizen_interaction' then
			local elements = {
				...
				{label = "Donner le Permis de Pêche",			value = 'peche'},
			...
			'default', GetCurrentResourceName(), 'citizen_interaction',
			{
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'ppa' then
						TriggerServerEvent('esx_policejob:givePPA', GetPlayerServerId(closestPlayer))
					elseif action == 'peche' then
						TriggerServerEvent('esx_policejob:givepeche', GetPlayerServerId(closestPlayer))
