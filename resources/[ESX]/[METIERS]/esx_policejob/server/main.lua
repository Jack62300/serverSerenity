...
RegisterServerEvent('esx_policejob:givePPA')
AddEventHandler('esx_policejob:givePPA', function(player)
		TriggerEvent('esx_license:addLicense', player, 'weapon', function ()
		LoadLicenses(player)
		end)
end)

RegisterServerEvent('esx_policejob:givepeche')
AddEventHandler('esx_policejob:givepeche', function(player)
		TriggerEvent('esx_license:addLicense', player, 'peche', function ()
		LoadLicenses(player)
		end)
end)
...
AddEventHandler('esx_policejob:getStockItem', function(itemName, count)
	...
	TriggerClientEvent('esx:showNotification', _source, "getStockItem triggered")
