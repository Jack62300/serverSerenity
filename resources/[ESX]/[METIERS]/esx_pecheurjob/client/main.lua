	...
	ESX.UI.Menu.Open(
		'default', GetCurrentResourceName(), 'cloakroom',
		{
			...
			elements = {
				...
				{label = _U('vine_clothes_vine'), value = 'pecheur_wear'},
			},
		},
		function(data, menu)
			...
			if data.current.value == 'pecheur_wear' then
				ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
...
function OpenPecheurActionsMenu()
	...
	ESX.UI.Menu.Open(
		'default', GetCurrentResourceName(), 'pecheur_actions',
		{
			title    = 'pecheur',
			align    = 'top-left',
			elements = elements
...
function OpenVehicleSpawnerMenu()
	...
	if Config.EnableSocietyOwnedVehicles then
		...
		local elements = {
			{label = 'Camion Benson',  value = 'benson'},
		}
...
function OpenVehicleSpawner2Menu()
	...
	if Config.EnableSocietyOwnedVehicles then
		...
		local elements = {
			{label = 'Bateau de Pêche',  value = 'dinghy'},
		}
...
function blips()
	if publicBlip == false then
		...
		AddTextComponentString("Fish of Anarchy")
