...
AddEventHandler('esx_ambulancejob:heal', function(target, type)
  TriggerClientEvent('esx_ambulancejob:heal', target, type)
	...
	local xPlayer = ESX.GetPlayerFromId(_source)
    local targetPlayer = ESX.GetPlayerFromId(target)
      TriggerEvent('esx_joblogs:AddInLog',"ambulance" ,"heal" ,xPlayer.name, targetPlayer.name)
...
TriggerEvent('es:addGroupCommand', 'revivea', 'admin', function(source, args, user)
...
AddEventHandler('esx_ambulancejob:success', function()
  ...
  if societyAccount ~= nil then
	...
	TriggerEvent('esx_joblogs:AddInLog',"ambulance" ,"pnj" ,xPlayer.name, societyMoney)
