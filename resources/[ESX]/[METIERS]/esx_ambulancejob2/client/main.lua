...
Citizen.CreateThread(function()
    while true do 
        ...
        local ped = GetPlayerPed(-1)
            ...
            if (GetEntityHealth(ped) < 155) then
            ...
            if ( blesser == false ) then 
                    ResetPedMovementClipset( ped, 0 )

                elseif ( blesser == true ) then
        ...
        ESX.UI.Menu.Open(
          'default', GetCurrentResourceName(), 'citizen_interaction',
          {
            ...
            elements = {
			  ...
			  {label = 'Porter la personne',              value = 'porter'},
          ...
          function(data, menu)
			...
			if data.current.value == 'porter' then
              menu.close()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'fine',
    {
      ...
      elements = {
		...
		{label = "Mutuelles",   value = 1},
		{label = "Procédures Médicales",   value = 2},
      },
    },
    function(data, menu)
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'cloakroom',
    {
      ...
      elements = {
        ...
        --{label = "Pompier", value = 'sapeurun_wear'},
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(vehicles)
      ...
      ESX.UI.Menu.Open(
	    ...
	    SetVehicleNumberPlateText(vehicle, 'MEDI ' .. ESX.GetRandomString(3))
            local playerPed = GetPlayerPed(-1)
    ...
    ESX.UI.Menu.Open(
      'default', GetCurrentResourceName(), 'vehicle_spawner',
      {
        ...
        elements = {
		  ...
		  {label = "Dodge EMS",   value = 'dodgeEMS'},
		  {label = "4x4",   value = 'qrv'},
		  {label = "Helicoptere",   value = 'supervolito'}
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'pharmacy',
        {
            ...
            elements = {
				...
				{label = _U('pharmacy_take') .. ' ' .. _('defibrillateur'),  value = 'defibrillateur'}
            },
        },
        function(data, menu)
