Locales['fr'] = {
  -- cloakroom
  ['cloakroom_menu'] = 'Vestiare',
  ['cloakroom_prompt'] = 'Appuie sur ~INPUT_CONTEXT~ pour ouvrir le ~y~vestiaire~s~.',
  ...
  ['spawnpoint_blocked'] = 'Un vehicule bloque le point de spawn!',
  ...
  ['billing'] = 'facuration',
  ['billing_sent'] = 'La facture a ete envoyee!',
  ['invoice_amount'] = 'montant de la facture',
  ['no_players_near'] = 'aucun joueur à proximite',
  ['start_job'] = 'start / stop PNJ Courses',
