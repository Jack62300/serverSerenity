...
function OpenActionMenuInteraction(target)
	...
	table.insert(elements, {label = ('Enlever son teeshirt'), value = 'tul'})
	table.insert(elements, {label = ('Enlever son pantanlon'), value = 'spo'})
	table.insert(elements, {label = ('Enlever ses chaussures'), value = 'but'})
	table.insert(elements, {label = ('Quitter'), value = 'quit'})
