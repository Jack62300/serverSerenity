...
ImportVehicleWarehouse = {
    ...
    LoadDefault = function()
        ...
        ImportVehicleWarehouse.Upper.Details.Enable(ImportVehicleWarehouse.Upper.Details.doorBlocker, true)
        RefreshInterior(ImportVehicleWarehouse.Upper.interiorId)

        ImportVehicleWarehouse.Lower.Ipl.Interior.Load()
        ImportVehicleWarehouse.Lower.Details.Enable(ImportVehicleWarehouse.Lower.Details.pump4, true)
